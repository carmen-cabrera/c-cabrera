...
::: {#hero-heading}
Carmen Cabrera is a **Lecturer in Geographic Data Science** (Assistant Professor) at the [Geographic Data Science Lab](https://www.liverpool.ac.uk/geographic-data-science/), within the [University of Liverpool](https://www.liverpool.ac.uk/)'s [Department of Geography and Planning](https://www.liverpool.ac.uk/geography-and-planning/). Her areas of expertise are geographic data science, machine learning, human mobility, network analysis and mathematical/statistical modelling. Carmen's research focuses on developing quantitative frameworks to model and predict **human mobility patterns across spatiotemporal scales and population groups**, ranging from intraurban commutes to migratory movements. She is interested in establishing methodologies to facilitate the efficient and reliable use of new forms of digital trace data in the study of human movement, particularly in disaster and data-scarce contexts.
